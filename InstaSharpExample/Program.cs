...
namespace InstaSharpExample
{
    internal class Program
    {
        ...
        {
            var uploader = new InstagramUploader("frankenstenvn", ConvertToSecureString("1q2w3e4r"));
            ...
            uploader.UploadImage(@"C:\\Users\\Public\\Pictures\\Sample Pictures\\Desert.jpg", "#demo #auto #upload");
